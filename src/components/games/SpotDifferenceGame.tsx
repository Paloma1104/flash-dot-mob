...
export function SpotDifferenceGame({ difficulty, onComplete, onCancel }: SpotDifferenceGameProps) {
      ...
      {isComplete ? (
        ...
        <View style={styles.gameContainer}>
          <View style={styles.instructionContainer}>
            <Text style={styles.instructionText}>Tap the cells that are different!</Text>
            <Text style={styles.hintText}>❌ = Different | 👀 Look for patterns</Text>
          </View>
          ...
          <View style={styles.grid}>
            {Array.from({ length: 25 }).map((_, index) => (
              ...
              >
                <LinearGradient colors={getCellColor(index)} style={styles.cellGradient}>
            ...
            <View style={styles.progressBar}>
              {differences.map((_, index) => (
                <View
                  ...
                  style={[
                    styles.progressDot,
                    { backgroundColor: index < found.length ? '#06FFA5' : '#1A1A2E' },
                  ]}
                />
              ))}
            </View>
