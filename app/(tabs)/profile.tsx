...
export default function LeaderboardScreen() {
  ...
  const [userRankEntry, setUserRankEntry] = useState<LeaderboardEntry | null>(
    null,
  );
  const [activeTab, setActiveTab] = useState<"stats" | "games" | "leaderboard">(
    "stats",
  );
        ...
        <View style={styles.rowLeft}>
          <View
            style={[
              ...
              item.rank <= 10 && styles.rankBadgeTop10,
            ]}
          >
            <Text
              style={[styles.rankText, item.rank <= 10 && styles.rankTextTop10]}
            >
              {item.rank}
            </Text>
          </View>
          ...
          <View style={styles.playerAvatar}>
            <IconSymbol
              name="person.fill"
              size={20}
              color={isUser ? "#836EF9" : "#fff"}
            />
          </View>

          <View style={styles.playerInfo}>
            <Text
              style={[styles.username, isUser && styles.usernameHighlight]}
              numberOfLines={1}
            >
    ...
    return (
      <View
        style={[
          ...
          { marginTop: position === 1 ? 0 : 20 },
        ]}
      >
        <View
          style={[
            styles.topPlayerCard,
            position === 1 && styles.topPlayerCardFirst,
          ]}
        >
          {/* Crown for 1st place */}
          {position === 1 && (
          ...
          >
            <LinearGradient
              colors={
                position === 1 ? ["#FFD700", "#FFA500"] : ["#836EF9", "#00D9FF"]
              }
          ...
          {/* Score */}
          <Text
            style={[styles.topScore, position === 1 && styles.topScoreFirst]}
          >
                ...
                <View style={styles.achievementsList}>
                  <View
                    style={[
                      ...
                      stats.totalClaims >= 1 && styles.achievementUnlocked,
                    ]}
                  >
                  ...
                  <View
                    style={[
                      styles.achievementItem,
                      stats.totalClaims >= 10 && styles.achievementUnlocked,
                    ]}
                  >
                    <View style={styles.achievementIconContainer}>
                      <Text style={styles.achievementEmoji}>
                  ...
                  >
                    ...
                    <View style={styles.achievementInfo}>
                      <Text
                        style={[
                          styles.achievementTitle,
                          balance >= 1000 && styles.achievementTitleUnlocked,
                        ]}
                      >
                        Whale Status
                      </Text>
                      <Text style={styles.achievementDesc}>
                        Accumulate 1,000 $MON
                      </Text>
                    </View>
                    {balance >= 1000 && (
                      <View style={styles.achievementCheck}>
                  ...
                  <View
                    style={[
                      styles.achievementItem,
                      stats.bestDrop >= 500 && styles.achievementUnlocked,
                    ]}
                  >
                    <View style={styles.achievementIconContainer}>
                      <Text style={styles.achievementEmoji}>
            ...
            <View style={styles.gamesTab}>
              ...
              <View style={styles.highScoresSection}>
                ...
                {Object.entries(gameStats.highScores).length > 0 ? (
                  Object.entries(gameStats.highScores).map(
                    ([gameType, score]) => {
                      ...
                      return (
                        <GlassCard key={gameType} style={styles.highScoreCard}>
                          ...
                          <View style={styles.highScoreInfo}>
                            <Text style={styles.highScoreName}>
                              {config.name}
                            </Text>
                  ...
                  <View style={styles.emptyGamesState}>
                    ...
                    <Text style={styles.emptyGamesSubtext}>
                      Find games on the map and start playing!
                    </Text>
                  </View>
                )}
              </View>
                  ...
                  <View style={styles.stickyLeft}>
                    ...
                    <View>
                      ...
                      <Text style={styles.stickyScore}>
                        {userRankEntry.totalEarned.toLocaleString()} $MON
                      </Text>
                    </View>
                  </View>
